  ...
  return (
    <div className="container mx-auto px-4 py-12 space-y-12">
      ...
      <div className="max-w-4xl mx-auto">
        <Link href="/locations/andhra-pradesh">
          <motion.div
            whileHover={{ y: -5 }}
            className="group"
          >
            <Card className="premium-card overflow-hidden border-none shadow-2xl bg-white dark:bg-zinc-900">
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="relative h-64 md:h-full">
                  <Image 
                    src="https://picsum.photos/seed/ap-state/800/600" 
                    alt="Andhra Pradesh" 
                    fill 
                ...
                <CardContent className="p-8 flex flex-col justify-center space-y-6">
                  <div>
                    <Badge className="bg-accent text-white border-none mb-2">Sunrise State</Badge>
                    ...
                    <p className="text-muted-foreground mt-2 leading-relaxed font-body">
                      The heart of South India, home to spiritual heights, vibrant coasts, and rich cultural heritage.
                    </p>
                  </div>
                  <div className="flex items-center gap-2 text-primary font-bold group-hover:gap-4 transition-all">
                    Explore 26 Districts <ArrowRight className="w-5 h-5" />
                  </div>
                </CardContent>
              </div>
            </Card>
      ...
      <div className="text-center pt-12">
        <p className="text-muted-foreground italic text-sm">More states coming soon...</p>
      </div>
    </div>
  );
}
