...
const TS_DISTRICTS = [
  { id: 'hyderabad', name: 'Hyderabad', region: 'Metropolis', image: 'https://picsum.photos/seed/hyd/800/600', count: 12 },
  { id: 'warangal', name: 'Warangal', region: 'Cultural Hub', image: 'https://picsum.photos/seed/warangal/800/600', count: 4 },
  { id: 'adilabad', name: 'Adilabad', region: 'Forests & Falls', image: 'https://picsum.photos/seed/adilabad/800/600', count: 2 },
  ...
  { id: 'mahabubnagar', name: 'Mahabubnagar', region: 'Heritage', image: 'https://picsum.photos/seed/mbnr/800/600', count: 2 },
  { id: 'karimnagar', name: 'Karimnagar', region: 'Forts', image: 'https://picsum.photos/seed/karimnagar/800/600', count: 1 },
  { id: 'medak', name: 'Medak', region: 'Historical', image: 'https://picsum.photos/seed/medak/800/600', count: 2 },
  { id: 'khammam', name: 'Khammam', region: 'Nature', image: 'https://picsum.photos/seed/khammam/800/600', count: 1 },
  { id: 'yadadri', name: 'Yadadri', region: 'Divine', image: 'https://picsum.photos/seed/yadadri/800/600', count: 1 },
  { id: 'mulugu', name: 'Mulugu', region: 'Wildlife', image: 'https://picsum.photos/seed/mulugu/800/600', count: 2 },
];
