...
export default function TSDistrictPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const getCategoryImage = (dest: any) => {
    ...
    // Category Fallbacks for visual diversity
    switch(dest.category.toLowerCase()) {
      case 'pilgrimage': return { url: 'https://picsum.photos/seed/ts-temple/600/400', hint: 'Indian Temple' };
      case 'nature': return { url: 'https://picsum.photos/seed/ts-nature/600/400', hint: 'Waterfall Forest' };
      case 'heritage': return { url: 'https://picsum.photos/seed/ts-heritage/600/400', hint: 'Ancient Monument' };
      case 'museum': return { url: 'https://picsum.photos/seed/ts-museum/600/400', hint: 'Museum Interior' };
      default: return { url: `https://picsum.photos/seed/ts-${dest.id}/600/400`, hint: 'Tourist Spot' };
    }
  };
