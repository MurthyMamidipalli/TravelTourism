...
const mockDestinations: Record<string, any> = {
  ...
  'araku-valley': { name: 'Araku Valley', district: 'Alluri Sitharama Raju', itinerary: '2 Days', category: 'Hill Station', lang: 'Telugu, Tribal', desc: 'Beautiful hill station with coffee plantations and tribal museums.' },
  ...
  'lambasingi': { name: 'Lambasingi', district: 'Alluri Sitharama Raju', itinerary: '2 Days', category: 'Hill Station', lang: 'Telugu', desc: 'Known as the Kashmir of Andhra Pradesh due to its winter frost.' },
